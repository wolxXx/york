...
class ModelGenerator extends \York\Console\Application{
	...
	public function run(){
		...
		$logger
			->addLogger(new \York\Logger\File('generateModels.all', $logger::LEVEL_ALL))
			->addLogger(new \York\Logger\File('generateModels.db.err', $logger::LEVEL_DATABASE_ERROR))
			->addLogger(new \York\Logger\File('generateModels.debug', $logger::LEVEL_DEBUG))
			->addLogger(new \York\Logger\File('generateModels.db.debug', $logger::LEVEL_DATABASE_DEBUG));
